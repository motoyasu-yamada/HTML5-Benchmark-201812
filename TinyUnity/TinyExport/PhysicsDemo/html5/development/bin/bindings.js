...
var game = game || {};
game.Move = function(arg0, arg1) {
  this._speed = (arg0|0);
  this._upForce = (arg1|0);
};
...
Object.defineProperties(game.Move.prototype, {
  ...
  upForce: {
    ...
    set: function(v) { this._upForce = (v|0); },
  },
});
game.Move._size = 8;
...
game.Move._typeDesc = (function() {
  return ut.meta.allocType(5, 'game.Move', 8, [
    ...
    {name: 'upForce', offset: 4, type: ut.meta.getType('int32')}
  ]);
})();
...
game.Move.upForce = { $ofs:4, $t:"int32_t", $c:game.Move };
var ut = ut || {};
ut.Core2D = ut.Core2D || {};
