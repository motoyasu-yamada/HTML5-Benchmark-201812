...
declare namespace ut{
    ...
    interface EntityGroups{
        ...
        game: {
            ...
            Explosion: EntityGroupData;
            GameMenu: EntityGroupData;
            GameOver: EntityGroupData;
            GameScene: EntityGroupData;
            GameWin: EntityGroupData;
            RaiderLaser: EntityGroupData;
            SpaceshipLaser: EntityGroupData;
        }
    }
}
