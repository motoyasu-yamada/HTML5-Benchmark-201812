...
entities.game.Image = entities.game.Image || {};
entities.game.Image.Component = function() {
};
entities.game.Image.Component.prototype = Object.create(null);
entities.game.Image.Component.prototype.constructor = entities.game.Image.Component;
Object.defineProperties(entities.game.Image.Component.prototype, {
});
entities.game.Image.Component._size = 1;
entities.game.Image.Component._fromPtr = function(ptr, v) {
  v = v || Object.create(entities.game.Image.Component.prototype);
  return v;
};
entities.game.Image.Component._toPtr = function(ptr, v) {
};
entities.game.Image.Component._toTempHeapPtr = function(ptr, v) {
};
entities.game.Image.Component._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) entities.game.Image.Component._toTempHeapPtr(ptr, v);
  return ptr;
};
entities.game.Image.Component.StorageView = function(ptr) {
  this._ptr = ptr;
};
entities.game.Image.Component.StorageView.prototype = Object.create(null);
entities.game.Image.Component.StorageView.prototype.constructor = entities.game.Image.Component.StorageView;
entities.game.Image.Component._view = entities.game.Image.Component.StorageView;
entities.game.Image.Component.StorageView._isSharedComp = entities.game.Image.Component._isSharedComp = false;
entities.game.Image.Component.StorageView._fromPtr = entities.game.Image.Component._fromPtr;
entities.game.Image.Component.StorageView._toPtr = entities.game.Image.Component._toPtr;
entities.game.Image.Component.StorageView._tempHeapPtr = entities.game.Image.Component._tempHeapPtr;
entities.game.Image.Component.StorageView._size = entities.game.Image.Component._size;
entities.game.Image.Component.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(entities.game.Image.Component.StorageView.prototype, {
});
entities.game.Image.Component._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// entities.game.Image.Component is a POD type, so a JavaScript side copy constructor entities.game.Image.Component._copyFn = function copy(src, dst) { ... } does not need to be generated for it
entities.game.Image.Component._typeDesc = (function() {
  return ut.meta.allocType(5, 'entities.game.Image.Component', 1, []);
})();
Object.defineProperties(entities.game.Image.Component, { cid: { configurable: true, get: function() { delete entities.game.Image.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.Image.Component.cid = Module._ut_component_register_cid_with_type(entities.game.Image.Component._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(entities.game.Image.Component.StorageView, { cid: { configurable: true, get: function() { return entities.game.Image.Component.cid; } } });
entities.game.Scene = entities.game.Scene || {};
entities.game.Scene.Component = function() {
};
entities.game.Scene.Component.prototype = Object.create(null);
entities.game.Scene.Component.prototype.constructor = entities.game.Scene.Component;
Object.defineProperties(entities.game.Scene.Component.prototype, {
});
entities.game.Scene.Component._size = 1;
entities.game.Scene.Component._fromPtr = function(ptr, v) {
  v = v || Object.create(entities.game.Scene.Component.prototype);
  return v;
};
entities.game.Scene.Component._toPtr = function(ptr, v) {
};
entities.game.Scene.Component._toTempHeapPtr = function(ptr, v) {
};
entities.game.Scene.Component._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) entities.game.Scene.Component._toTempHeapPtr(ptr, v);
  return ptr;
};
entities.game.Scene.Component.StorageView = function(ptr) {
  this._ptr = ptr;
};
entities.game.Scene.Component.StorageView.prototype = Object.create(null);
entities.game.Scene.Component.StorageView.prototype.constructor = entities.game.Scene.Component.StorageView;
entities.game.Scene.Component._view = entities.game.Scene.Component.StorageView;
entities.game.Scene.Component.StorageView._isSharedComp = entities.game.Scene.Component._isSharedComp = false;
entities.game.Scene.Component.StorageView._fromPtr = entities.game.Scene.Component._fromPtr;
entities.game.Scene.Component.StorageView._toPtr = entities.game.Scene.Component._toPtr;
entities.game.Scene.Component.StorageView._tempHeapPtr = entities.game.Scene.Component._tempHeapPtr;
entities.game.Scene.Component.StorageView._size = entities.game.Scene.Component._size;
entities.game.Scene.Component.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(entities.game.Scene.Component.StorageView.prototype, {
});
entities.game.Scene.Component._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// entities.game.Scene.Component is a POD type, so a JavaScript side copy constructor entities.game.Scene.Component._copyFn = function copy(src, dst) { ... } does not need to be generated for it
entities.game.Scene.Component._typeDesc = (function() {
  return ut.meta.allocType(5, 'entities.game.Scene.Component', 1, []);
})();
Object.defineProperties(entities.game.Scene.Component, { cid: { configurable: true, get: function() { delete entities.game.Scene.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.Scene.Component.cid = Module._ut_component_register_cid_with_type(entities.game.Scene.Component._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(entities.game.Scene.Component.StorageView, { cid: { configurable: true, get: function() { return entities.game.Scene.Component.cid; } } });
var game = game || {};
game.ImageTag = function() {
};
game.ImageTag.prototype = Object.create(null);
game.ImageTag.prototype.constructor = game.ImageTag;
Object.defineProperties(game.ImageTag.prototype, {
});
game.ImageTag._size = 1;
game.ImageTag._fromPtr = function(ptr, v) {
  v = v || Object.create(game.ImageTag.prototype);
  return v;
};
game.ImageTag._toPtr = function(ptr, v) {
};
game.ImageTag._toTempHeapPtr = function(ptr, v) {
};
game.ImageTag._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) game.ImageTag._toTempHeapPtr(ptr, v);
  return ptr;
};
game.ImageTag.StorageView = function(ptr) {
  this._ptr = ptr;
};
game.ImageTag.StorageView.prototype = Object.create(null);
game.ImageTag.StorageView.prototype.constructor = game.ImageTag.StorageView;
game.ImageTag._view = game.ImageTag.StorageView;
game.ImageTag.StorageView._isSharedComp = game.ImageTag._isSharedComp = false;
game.ImageTag.StorageView._fromPtr = game.ImageTag._fromPtr;
game.ImageTag.StorageView._toPtr = game.ImageTag._toPtr;
game.ImageTag.StorageView._tempHeapPtr = game.ImageTag._tempHeapPtr;
game.ImageTag.StorageView._size = game.ImageTag._size;
game.ImageTag.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(game.ImageTag.StorageView.prototype, {
});
game.ImageTag._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// game.ImageTag is a POD type, so a JavaScript side copy constructor game.ImageTag._copyFn = function copy(src, dst) { ... } does not need to be generated for it
game.ImageTag._typeDesc = (function() {
  return ut.meta.allocType(5, 'game.ImageTag', 1, []);
})();
Object.defineProperties(game.ImageTag, { cid: { configurable: true, get: function() { delete game.ImageTag.cid; var offsetsPtr = 0, offsetsCount = 0; return game.ImageTag.cid = Module._ut_component_register_cid_with_type(game.ImageTag._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(game.ImageTag.StorageView, { cid: { configurable: true, get: function() { return game.ImageTag.cid; } } });
var ut = ut || {};
ut.Core2D = ut.Core2D || {};
