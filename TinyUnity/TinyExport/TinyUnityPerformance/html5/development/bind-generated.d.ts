...
declare namespace game{
    class ImageTag extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: ImageTag): ImageTag;
        static _toPtr(p: number, v: ImageTag): void;
        static _tempHeapPtr(v: ImageTag): number;
        static _dtorFn(v: ImageTag): void;
    }
}
declare namespace ut{
}
...
declare namespace ut{
    ...
    interface EntityGroups{
        ...
        game: {
            ...
            Image: EntityGroupData;
            Scene: EntityGroupData;
        }
    }
}
